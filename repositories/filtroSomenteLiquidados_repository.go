...
func (repository *FiltroSomenteLiquidadosRepository) GetAllFiltroSomenteLiquidados(unidadeGestoraCodigo, ano, dataInicioStr, dataFimStr string) ([]models.FiltroSomenteLiquidados, error) {
	...
	var filterSomenteLiquidados []models.FiltroSomenteLiquidados
	for rows.Next() {
		var f models.FiltroSomenteLiquidados
		if err := rows.Scan(
			&f.Emp_Data,
			&f.Emp_Numero,
			&f.Credor,
