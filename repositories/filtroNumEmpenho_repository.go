...
func (repository *FiltroNumEmpenhoRepository) GetFiltroNumEmpenho(unidadeGestoraCodigo, ano, numEmpenho string) ([]models.FiltroNumEmpenho, error) {
	...
	rows, err := repository.db.Query(query, unidadeGestoraCodigo, ano, numEmpenho)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
	var filtroNumEmpenhos []models.FiltroNumEmpenho
	for rows.Next() {
		var filtroNumEmpenho models.FiltroNumEmpenho
		if err := rows.Scan(
			&filtroNumEmpenho.Emp_Data,
			&filtroNumEmpenho.Emp_Numero,
			&filtroNumEmpenho.Credor,
			&filtroNumEmpenho.Valor_Empenhado,
			&filtroNumEmpenho.Valor_Liquidado,
			&filtroNumEmpenho.Valor_Pago,
			&filtroNumEmpenho.Valor_PagoRetencao,
			&filtroNumEmpenho.Anulado_Empenho,
			&filtroNumEmpenho.Qtde_Notas_Fiscais,
			&filtroNumEmpenho.Qtde_NFe,
			&filtroNumEmpenho.Contratos,
			&filtroNumEmpenho.Ent_codigo,
			&filtroNumEmpenho.Qtde_beneficiarios,
			&filtroNumEmpenho.Instrumento_contrato,
			&filtroNumEmpenho.Fonte_recurso_fonte,
			&filtroNumEmpenho.Tipo_concurso,
			&filtroNumEmpenho.Num_Concurso,
			&filtroNumEmpenho.Assistencia_social,
			&filtroNumEmpenho.Diarias,
			&filtroNumEmpenho.Relevante,
			&filtroNumEmpenho.Unidade_gestora,
			&filtroNumEmpenho.Municipio,
			&filtroNumEmpenho.Exercicio,
			&filtroNumEmpenho.Codigo_ug,
			&filtroNumEmpenho.Projeto_atividade,
			&filtroNumEmpenho.Dotacao,
			&filtroNumEmpenho.Num_obra,
			&filtroNumEmpenho.Tipo_serv_engenharia,
			&filtroNumEmpenho.Destinacao_recurso_grupo,
			&filtroNumEmpenho.Destinacao_recurso_iduso,
			&filtroNumEmpenho.Destinacao_recurso_codiog_iduso,
			&filtroNumEmpenho.Codigo_destinacao_recurso,
			&filtroNumEmpenho.Codigo_destinacao_recurso_especificacao,
			&filtroNumEmpenho.Destinacao_recurso_codigo_grupo,
			&filtroNumEmpenho.Fund_compra_direta_codigo,
			&filtroNumEmpenho.Fund_compra_direta_descricao,
			&filtroNumEmpenho.Destinacao_recurso,
			&filtroNumEmpenho.Orgao,
			&filtroNumEmpenho.UnidadeOrcamentaria,
			&filtroNumEmpenho.Unidade_orcamentaria_codigo,
			&filtroNumEmpenho.Funcao_codigo,
			&filtroNumEmpenho.Funcao_descricao,
			&filtroNumEmpenho.Subfuncao_codigo,
			&filtroNumEmpenho.Subfuncao_descricao,
			&filtroNumEmpenho.Programa_codigo,
			&filtroNumEmpenho.Num_Projeto_Atividade,
			&filtroNumEmpenho.Categoria_Economica,
			&filtroNumEmpenho.Natureza_Despesa,
			&filtroNumEmpenho.Modalidade_aplicacao_codigo,
			&filtroNumEmpenho.Elemento_despesa_codigo,
			&filtroNumEmpenho.Elemento_despesa_descricao,
			&filtroNumEmpenho.Subelemento_despesa_codigo,
			&filtroNumEmpenho.Subelemento_despesa,
			&filtroNumEmpenho.Descricao,
			&filtroNumEmpenho.Num_processo_licitatorio,
			&filtroNumEmpenho.Tipo_Contrato,
			&filtroNumEmpenho.Num_aditivo_contrato,
			&filtroNumEmpenho.Num_convenio,
			&filtroNumEmpenho.Num_aditivo_convenio,
			&filtroNumEmpenho.Compra_direta,
			&filtroNumEmpenho.Tipo,
			&filtroNumEmpenho.Mes_referencia,
			&filtroNumEmpenho.Identificacao_credor,
			&filtroNumEmpenho.Tipo_pesssoaCodigo,
		); err != nil {
			return nil, err
		}
		filtroNumEmpenhos = append(filtroNumEmpenhos, filtroNumEmpenho)
	}
	return filtroNumEmpenhos, nil
}
