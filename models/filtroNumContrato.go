...
// EmpenhoDetalhado contém todos os 79 campos retornados pela query de empenhos.
// A estrutura está organizada em blocos lógicos para facilitar a manipulação dos dados.
type FiltroNumContrato struct {
